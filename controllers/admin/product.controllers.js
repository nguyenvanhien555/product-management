...
module.exports.changeMulti = async (req, res) => {
  ...
  switch (type) {
    ...
    case "change-position":
      ...
      req.flash("success", `Da thay doi vi tri thanh cong ${ids.length} san pham`);
      break;
    default:
      break;
  }
...
module.exports.edit = async (req, res) => {
  try {
    ...
    req.flash("notExists", "Khong ton tai san pham");
    res.redirect(`${systemConfig.prefixAdmin}/products`);
  }
};
...
module.exports.detail = async (req, res) => {
  try {
    ...
    req.flash("error", "Co loi xem chi tiet san pham");
  };
};